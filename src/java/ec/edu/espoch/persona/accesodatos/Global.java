 ...
 */
package ec.edu.espoch.persona.accesodatos;
...
public final class Global {
    ...
    java.util.ResourceBundle Configuracion = java.util.ResourceBundle.getBundle("ec.edu.espoch.persona.accesodatos.database",lt);
